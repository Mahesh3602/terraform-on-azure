...
resource "azuread_service_principal" "vnet_peering" {
  application_id = azuread_application.vnet_peering.applapplication_id  
}

resource "azuread_service_principal_password" "vnet_peering" {
  service_principal_id = azuread_service_principal.vnet_peering.application_id
...
resource "azurerm_role_assignment" "vnet" {
  ...
  role_definition_id = azurerm_role_definition.vnet_peering.id
